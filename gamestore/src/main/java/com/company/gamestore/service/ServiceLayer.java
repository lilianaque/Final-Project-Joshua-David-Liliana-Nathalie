...
// Adding processing fee
    ...
    private InvoiceViewModel buildInvoiceViewModel(Invoice invoice) {
        ...
        ivm.setItemId(invoice.getId());
        ivm.setCustomerName(invoice.getName());
        ivm.setStreet(invoice.getStreet());
        ivm.setCity(invoice.getCity());
        ivm.setState(invoice.getState());
        ivm.setZipcode(invoice.getZipcode());
        ivm.setItemType(invoice.getItem_type());
        ivm.setItemId(invoice.getItem_id());
        ivm.setQuantity(invoice.getQuantity());
        ivm.setUnitPrice(invoice.getUnit_price());
        ivm.setTax(invoice.getTax());
        ivm.setSubtotal(invoice.getSubtotal());
        ivm.setProcessingFee(invoice.getProcessing_fee());
    ...
    public InvoiceViewModel findInvoiceById(Integer id) {
        Optional<Invoice> returnedInvoice = invoiceRepo.findById(id);
        return returnedInvoice.isPresent() ? buildInvoiceViewModel(returnedInvoice.get()) : null;
    }

    public List<InvoiceViewModel> findAllInvoices() {
        List<Invoice> returnedInvoices = invoiceRepo.findAll();
    ...
    public List<InvoiceViewModel> findInvoiceByName(String name) {
        List<Invoice> returnedInvoices = invoiceRepo.findByName(name);
